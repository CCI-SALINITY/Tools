...
% profondeur : 5 m
% creation d'un fichier .mat SSSisas_CATDS.mat contenant les cartes ISAS 5m interpolées sur la grille EASE
% 

clear
set(groot,'DefaultFigureColormap',jet)

load('I:\dataSMOS\ISAS15\ISAS15_Argo_only_SSS_SST_5m_2010_2015.mat')
yearisas=year;
monthisas=month;
latisas=latmapISAS;
lonisas=lonmapISAS;
nlon=length(lonmapISAS);
nlat=length(latisas);
...
[lat0, lon0]=meshgrid(lat_ease,lon_ease);
...
save('isas_CATDS.mat', 'isasSSS', 'isasTEMP', 'lat_fixgrid' ,'lon_fixgrid', 'dateisas', 'datemois_isas');
